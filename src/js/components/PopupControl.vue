<template>
  <div v-if="shown" id="popper" ref="popper" class="popper z-50 bg-white border border-gray-200 rounded-lg shadow-lg max-w-sm">
    <transition
    ...
    >
      <div class="overflow-hidden rounded-lg">
        <div v-if="$slots.header" class="bg-gray-50 border-b border-gray-200 text-sm font-semibold text-gray-900">
