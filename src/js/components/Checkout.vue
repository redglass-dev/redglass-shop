    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6 mt-8">
            ...
            <div class="sm:col-span-6">
              ...
              <input
                ...
                required
              />
              <p v-if="form.errors.has('Email')" class="mt-1 text-xs text-red-600">{{ form.errors.get('Email') }}</p>
            </div>
            ...
            <div class="sm:col-span-6">
              ...
              <input
                ...
                id="Company"
                class="block w-full rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                :class="{ 'border-red-500': form.errors.has('Company') }"
                @change="clearErrors('Company')"
                v-model="form.Company"
              />
              <p v-if="form.errors.has('Company')" class="mt-1 text-xs text-red-600">{{ form.errors.get('Company') }}</p>
            </div>
            ...
            <div class="sm:col-span-3">
              ...
              <input
                ...
                @change="clearErrors('FirstName')"
                v-model="form.FirstName"
              />
              <p v-if="form.errors.has('FirstName')" class="mt-1 text-xs text-red-600">{{ form.errors.get('FirstName') }}</p>
            </div>
            ...
            <div class="sm:col-span-3">
              ...
              <input
                ...
                @change="clearErrors('LastName')"
                v-model="form.LastName"
              />
              <p v-if="form.errors.has('LastName')" class="mt-1 text-xs text-red-600">{{ form.errors.get('LastName') }}</p>
            </div>
            ...
            <div class="sm:col-span-6">
              ...
              <input
                ...
                v-model="form.Phone"
              />
              <p v-if="form.errors.has('Phone')" class="mt-1 text-xs text-red-600">{{ form.errors.get('Phone') }}</p>
            </div>
          </div>
        </div>
      ...
      <div class="space-y-8">
        <div>
          ...
          <div class="mb-6">
            <label for="Memo" class="block text-sm font-medium text-gray-700 mb-1">Order Notes (Optional)</label>
            <textarea
              id="Memo"
              rows="2"
              class="block w-full rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
        ...
        <div>
          ...
          <div v-if="user && allowOrder && user.accountGuid !== ''" class="bg-white border rounded-lg p-6 shadow-sm mb-6">
            <div class="flex items-center justify-between">
              <span class="text-sm font-medium text-gray-700">Order on Account: <span class="font-bold">{{ user.company }}</span></span>
              <button
                type="button"
                class="inline-flex items-center px-6 py-2 border border-transparent text-sm font-bold rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50 transition-colors"
          ...
          <div v-if="allowCard" class="bg-white border rounded-lg p-6 shadow-sm">
            <div class="space-y-6">
              <div>
                ...
                <input
                  ...
                  id="nameOnCard"
                  class="block w-full rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                  :class="{ 'border-red-500': form.errors.has('nameOnCard') }"
                  v-model="nameOnCard"
                  @change="clearErrors('nameOnCard')"
                  required
                />
                <p v-if="form.errors.has('nameOnCard')" class="mt-1 text-xs text-red-600">{{ form.errors.get('nameOnCard') }}</p>
              </div>

              <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Card Details</label>
                <div ref="cardRef" id="card-ref" class="block w-full rounded-md border border-gray-300 px-3 py-3 shadow-sm focus-within:ring-1 focus-within:ring-indigo-500 focus-within:border-indigo-500"></div>
              ...
              <div class="pt-4">
                <button
                  type="button"
                  class="w-full inline-flex justify-center items-center px-8 py-4 border border-transparent text-xl font-bold rounded-md shadow-sm text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 disabled:opacity-50 transition-colors"
